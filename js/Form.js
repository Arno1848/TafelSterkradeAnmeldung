...
apiCall('getAllGeburtstage', {}) 
    .then(daten => {
        ...
        console.log("CLIENT: alleGeburtstageCache:", alleGeburtstageCache.length);
        
        let GeburtsdatumTagevoraus = GeburtsdatumWochenvoraus * 7;
        bevorstehendeGeburtstage = filterGeburtstageByTageVoraus(alleGeburtstageCache, GeburtsdatumTagevoraus);
