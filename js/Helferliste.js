...
//-----------------------------------------------
  ...
  // Hier wird die Liste nur angezeigt, der Export-Aufruf kommt später
  // Wir nutzen showOverlayRapport als Basis, bis wir ein separates Overlay haben
  
  showOverlayHelferliste(daten);
  
  // Die Funktion createRapport/updateSheetRapport wird hier nicht benötigt,
  // da die Liste direkt aus dem Cache angezeigt wird.
}
